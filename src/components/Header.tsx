...
import { NewHabitForm } from "./NewHabittForm";
export function Header() {
  return (
    <div className="w-full max-w-3xl mx-auto flex items-center justify-between">
      <img src={LogoHabits} alt="Logo Habits" />
      <Dialog.Root>
        <Dialog.Trigger className=" flex border border-violet-500 font-semibold rounded-lg px-6 py-4 items-center gap-3 hover:border-violet-300">
